...
/**
 * Test case for class LS\Shopware\Controller\ProductController.
 *
...
class ProductControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \LS\Shopware\Controller\ProductController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('LS\\Shopware\\Controller\\ProductController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView() {
		...
		$productRepository = $this->getMock('LS\\Shopware\\Domain\\Repository\\ProductRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenProductToView() {
		$product = new \LS\Shopware\Domain\Model\Product();
